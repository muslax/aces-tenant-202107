...
export function createSchedules(bid, groups) {
  ...
  for (let i = 0; i < div; i++) divSlots.push({asd: `TD 0${i + 1}`, asw: `TW 0${i + 1}`, slot1: 'interview', slot2: 'diskusi', slot3: 'online', slot4: 'online'});
  for (let i = 0; i < div; i++) divSlots.push({asd: `TD 0${i + 1}`, asw: `TW 0${i + 1}`, slot1: 'diskusi', slot2: 'interview', slot3: 'online', slot4: 'online'});
  for (let i = 0; i < div; i++) divSlots.push({asd: `TD 0${i + 1}`, asw: `TW 0${i + 1}`, slot1: 'online', slot2: 'online', slot3: 'interview', slot4: 'diskusi'});
  for (let i = 0; i < div; i++) divSlots.push({asd: `TD 0${i + 1}`, asw: `TW 0${i + 1}`, slot1: 'online', slot2: 'online', slot3: 'diskusi', slot4: 'interview'});
