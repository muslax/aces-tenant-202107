    ...
    <div id="page-loading" className="flex flex-col justify-center py-8">
      ...
      >
        <g transform="rotate(180 50 50)">
          <rect x="6.111111111111111" y="12.5" width="10" height="30" fill="rgba(91, 204, 119, 0.75)">
          ...
          <rect x="17.22222222222222" y="12.5" width="10" height="30" fill="rgba(91, 204, 119, 0.75)">
          ...
          <rect x="28.333333333333336" y="12.5" width="10" height="30" fill="rgba(91, 204, 119, 0.75)">
          ...
          <rect x="39.44444444444444" y="12.5" width="10" height="30" fill="rgba(91, 204, 119, 0.75)">
          ...
          <rect x="50.55555555555556" y="12.5" width="10" height="140" fill="rgba(91, 204, 119, 0.75)">
          ...
          <rect x="61.66666666666667" y="12.5" width="10" height="40" fill="rgba(91, 204, 119, 0.75)">
          ...
          <rect x="72.77777777777777" y="12.5" width="10" height="40" fill="rgba(91, 204, 119, 0.75)">
          ...
          <rect x="83.88888888888889" y="12.5" width="10" height="40" fill="rgba(91, 204, 119, 0.75)">
